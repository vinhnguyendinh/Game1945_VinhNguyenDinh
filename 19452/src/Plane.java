...
public class Plane extends GameObject implements Subject{
    ...
    public void draw(Graphics g){
        ...
        g.fillRect(PlaneManager.getInstance().getPlaneMoveByKey().getPositionX() + 10,
                   PlaneManager.getInstance().getPlaneMoveByKey().getPositionY() + 70,
                   PlaneManager.getInstance().getPlaneMoveByKey().getHealth() + 10, 10);
        g.fillRect(PlaneManager.getInstance().getPlaneMoveByMouse().getPositionX() + 10,
                   PlaneManager.getInstance().getPlaneMoveByMouse().getPositionY() + 70,
                   PlaneManager.getInstance().getPlaneMoveByMouse().getHealth() + 10, 10);
